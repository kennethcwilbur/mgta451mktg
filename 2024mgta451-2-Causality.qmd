...
::: aside
[source.](https://drive.google.com/file/d/126xyjFPuZAQW3EcHIa_LPKN_yc5QU3zB/view?usp=sharing)
Publishers sell "Opportunites to See", not "Exposures" ; see [Viewability](https://en.wikipedia.org/wiki/Media_Rating_Council#Viewability_standard)
:::

## 

![](images/ads_ds_buy.png){fig-align="center" height=7in}
...
- Ad profit > 0 if transaction margin > $20
          ...
          - But we also had to advertise to 999 people who didn't buy

- Or, ad profit > 0 if customer CLV > $20 *and* if the customer would not have purchased otherwise
...
Corr(ad,sales) contains some truth

          - If ads cause sales, then corr(ad,sales)>0

Some products/channels just don't sell without ads

          - E.g., Direct response TV ads for 1800 #s
...
- Google and Meta obfuscate ad placement algorithms

          - How many ad placements are incremental?
          - How many ad placements target likely converters?
          - How can advertisers react to adversarial ad price adjustments?
          - How can advertisers evaluate brand safety, targeting, other contextual elements?
...
- To balance ad platform power, know your ad profits, vote with your feet
...
![](images/gmz_fig3.png){fig-align="center" width=10in}

## 

![](images/gmz_fig4.png){fig-align="center" width=7in}

##

![](images/gmz_fig10a.png){fig-align="center" width=10in}


##

![](images/gmz_fig11.png){fig-align="center" width=6in}
...
![](images/gtrends_adexp.png){fig-align="center" width=9in}
          ...
          - More like podcasts v AM radio than like streaming v CDs
...
::: aside
- Right question: what % of sales to spend on experiments to learn to get more sales, then use incremental returns & risk to inform the budget
:::
...
- Converting correlational efforts to incremental is a resume headline and interesting challenge

          - Suggests a narrow view of experiments or how to act on them
          - Understanding that view is a first step toward addressing it
          - Also might suggest an ad agency background

- Correlational + Incremental > Either alone

          - What version of incrementality might they value?
          
- Going-dark design

          - Turn off ads in (truly) random 10% of places/times; nominally free
          - Compare measured sales to ex-ante modeled predictions
          - Can that comparison improve our model & motivate more experiments?
          
- If structural incentives misalign, consider a new role

          - Life is too short, do something meaningful          
...
- Ad effects are subtle but that does not necessarily imply unprofitability
