...
format:
  revealjs:
    ...
    slide-number: c
    chalkboard: true
    pdf-max-pages-per-slide: 1  # avoid multi-page slides
...
![](images/retailmedia1.png){fig-align="center" width="5.8in"}
...
::: aside
More discussion [here](https://archive.ph/WfdAc){target="_blank"}
:::
...
::: aside
[[1]](https://www.iab.com/wp-content/uploads/2020/12/IAB_Brand_Safety_and_Suitability_Guide_2020-12.pdf){target="_blank"}. Ads have even [been found](https://www.bbc.com/future/article/20250207-how-google-amazon-and-microsoft-funnelled-ad-money-to-a-site-hosting-child-abuse-images){target="_blank"} served with csam
:::
...
![](images/ebay1.png){fig-align="center" width="5in"}

::: aside
[source](https://drive.google.com/file/d/1SEQ8YCHFw08Z0zmdQlOoAXIJUlq5Q06q/view?usp=drive_link){target="_blank"}
:::
...
![](images/ebay2.png){fig-align="center" width="9in"}
...
![](images/ebay3.png){fig-align="center" width="8in"}

    - Attributed sales fell, but actual sales didn't. Hmmm
    - These results led to changes in eBay's ad measurement 

::: aside
[source](https://drive.google.com/file/d/1SEQ8YCHFw08Z0zmdQlOoAXIJUlq5Q06q/view?usp=drive_link){target="_blank"}, [hbr writeup](https://hbr.org/2013/03/did-ebay-just-prove-that-paid){target="_blank"}. [Central Control (2025)](https://drive.google.com/file/d/1VY3tIBZhXY9OA4hk8bgUDVsp69XtQwKQ/view?usp=drive_link){target="_blank"} offers ad geo test designs & code
::: 
...
![](images/adv-def.png){fig-align="center" width="2in"}          
...
```         
      ...
      Marginal ROAS (mROAS) is the tangent to the curve
...
::: aside
[source](https://facebookexperimental.github.io/Robyn/docs/features/){.smaller target="_blank"}
:::
...
![](images/albertsons.png){fig-align="center" width="6in"}

::: aside
[source](https://drive.google.com/file/d/1uyHTykDk3m309orrv5AKKHMzkTDDTYtM/view?usp=drive_link){target="_blank"}
:::

::: notes
Albertsons media group reported a meta-analysis of campaigns, and how correlational ROAS covaried with common measurement choices
:::
...
::: aside
Rare exception: [Amazon Ads MTA](https://drive.google.com/file/d/1n3Jio5ggXfkzw1qCS2lmKJsm6kyPdQxA/view?usp=drive_link){target="_blank"} embeds incrementality 
:::
...
![](images/gtrends_adexp.png){fig-align="center" width="7.5in"}
...
- Prominent exception: [Ghost ads](https://drive.google.com/file/d/1V9_YHaeiwZkIp4zE3bHhvfRfa-4KrOmT/view?usp=drive_link){target="_blank"}, an ingenious system to randomly withhold ads from auctions in order to estimate causal ad effects
          
::: aside
See also: [Haus blog](https://www.haus.io/blog/what-youre-actually-measuring-in-a-platform-a-b-test){target="_blank"}, [Braun & Schwartz (2025)](https://drive.google.com/file/d/11BhiE3wJqaKQ9S73Mjt1hbZJRhkvZvv5/view?usp=drive_link){target="_blank"}, [Boegershausen et al.](https://drive.google.com/file/d/1bygkM2hgmTL8fbMrebozy_LT-w4EYSOB/view?usp=sharing){target="_blank"}
::: 
...
E.g., [Shapiro et al. (2021)](https://drive.google.com/file/d/1f3JLTvIsltKej0DDae_vkZyAOmBXI13Y/view?usp=drive_link){target="_blank"} used the county-border approach to identify excessive TV advertising 
...
-   Experiments & quasi-experiments should be "yes-if-valid," <br>not "either-or"
...
::: aside 
This [MSI White Paper](https://github.com/kennethcwilbur/website/raw/master/MSI-MMM-Blue-Ribbon-Panel-Report-Updated.pdf){target="_blank"} offers more MMM details; more on [causal calibration](https://sellforte.com/blog/calibrating-marketing-mix-models-with-experiments-and-attribution-data){target="_blank"} here
:::
